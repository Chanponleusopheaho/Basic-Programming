...
while True:
  ...
  if user == "3":
    ...
    if sign == "Sagittarius":
      print("Another Sagittarius or a Gemini would definitely be able to vibe with that type of inquisitive and energetic lifestyle. Aries, another sign that loves to be active, may also be able to provide a firm, guiding hand where one is needed.")
      print("Sagittarius is too rambunctious for the likes of Capricorn and Taurus and isn’t skilled enough at communicating emotions to successfully date a Pisces.")
        ...
        print("Compatability: Virgos and other Capricorns appreciate and respect the drive this sign has, and they sympathize with the desire to be perfect. Scorpios know that there is more to this sign than meets the eye, as they are often misunderstood themselves.")
        print("Non-Compatability: On the other hand, Leo, Gemini, and Sagittarius view Capricorn as being overly serious and stodgy.")
    elif sign == "Aquarius":
